...
import { Shield, BookOpen, BarChart3, HelpCircle, Search, Camera, Accessibility, Globe, Mic, Menu, X, MessageSquare, GitCompare } from 'lucide-react'
...
export default function Layout() {
  ...
  const navItems = [
    ...
    { to: '/image-compare', icon: GitCompare, label: 'Compare' },
